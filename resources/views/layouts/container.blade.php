<body class="dcat-admin-body sidebar-mini layout-fixed {{ $configData['body_class']}} {{ $configData['sidebar_class'] }}
...
<footer class="main-footer pt-1">
    <p class="clearfix blue-grey lighten-2 mb-0 text-center">
        ...
        <span class="text-center d-block d-md-inline-block mt-25">
            ...
            <a  target="_blank" href="https://learnku.com/docs/dcat-admin/2.x">.</a>
        </span>
